package com.edu.hust.word.similarity.hownet.sememe;
 ...
 * @author xuming
 */
public abstract class SememeParser implements IHownetMeta, ISimilarity,Serializable {
    private static final long serialVersionUID = 2354712066748743599L;
    ...
    public SememeParser() throws IOException {
        ...
        InputStream inputStream = new GZIPInputStream(SememeParser.class.getResourceAsStream("/" + path));
        load(inputStream);
    }
